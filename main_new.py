...
class agro_sim():
    ...
    def show(self):
        cv2.resize(self.field , (1080, 1920), interpolation = cv2.INTER_AREA)
        cv2.imshow("Field", self.field)
        cv2.waitKey(5)

if __name__ == "__main__":
    
    sf = shapefile.Reader("Belarus/Belarus")
    s = sf.shape(0)
    points = s.points
    sim = agro_sim(3, sf.bbox, 6, 5)
    sim.draw_contour(points, 1)
    #o_point = (27.356284260749817, 53.26796896274332)
    #d_point = (27.356284260749817, 53.26796896274332)
